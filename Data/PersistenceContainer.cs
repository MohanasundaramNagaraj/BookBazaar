...
using BookBazaar.Data.Repository;
...
namespace BookBazaar.Data
{
    public static class PersistenceContainer
    {
        public static IServiceCollection AddPersistenceServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped(typeof(IGenericRepository<Book>), typeof(GenericRepository<Book>));
            ...
            services.AddScoped(typeof(IUnitOfWork<Book>), typeof(UnitOfWork<Book>));
