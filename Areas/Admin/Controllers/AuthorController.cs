...
#pragma warning disable
    ...
    public class AuthorController : Controller
    {
        ...
        {
            var authors = await _author.Entity.GetAllAsync(filter: null, includeProperties: a => a.Books);
            return View(authors);
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            Author autor = await _author.Entity.GetFirstOrDefaultAsync(a => a.Id == id, includeProperties: "Books");
